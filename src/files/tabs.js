...
!function() {
   ...
   */
   ...
   jsTabs.generate = (tabs) => {
      html = `<div class="jstabs"><div class="tabs">`;
      html += tabs.map(o => {
         let id = o.id ? ` id="${o.id}"` : '';
   ...
   if (typeof define === "function" && define.amd) define(jsTabs); else if (typeof module === "object" && module.exports) module.exports = jsTabs;
   this.jsTabs = jsTabs;
