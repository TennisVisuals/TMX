...
export const tournamentDisplay = function() {
   ...
   function createTournamentContainer({tournament, dbmatches, selected_tab, display_points = false, editing}) {
      ...
      function enableTournamentOptions() {
         ...
         container.publish_notes.element.style.display = bool && same_org ? 'inline' : 'none';
      ...
      function configureEventSelections(e) {
         ...
         if (event_rank) { details.rank.ddlb.setValue(event_rank, 'white'); }
      ...
      function afterScoreUpdate(e) {
         ...
         if (staging.broadcasting()) {
            if (fx.fx.env().livescore) {
               // TODO: include this in registerAcknowledgement
               e.up_to_date = true;
